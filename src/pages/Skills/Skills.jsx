...
const SkillsSection = () => {
    const skillCategories = [
        ...
        },
        {
            ...
            skills: [
                ...
                {
                    name: "SQL",
                    icon: <SiMysql className="w-4 h-4 text-[#36791]" />
                },
            ],
        },
        {
        ...
        },
        {
            ...
            skills: [
                ...
                {
                    name: "Git",
                    icon: <FaGitAlt className="w-4 h-4 text-[#FCC624]" />
                },
                {
                    name: "Github",
                    icon: <FaGithub className="w-4 h-4 text-[#FCC624]" />
                },
            ],
        },
    ];
    ...
    return (
        <main className="pt-15 lg:pt-0 text-white min-h-screen bg-[#04081A] relative">
            {/* Grid Background */}
            <div className="container mx-auto px-4 py-11 relative z-10"></div>
