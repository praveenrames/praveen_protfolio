          ...
          <Card
            ...
            <motion.div
              ...
              <p className="text-gray-300 text-lg leading-relaxed">
                I am a Full Stack Developer (MERN) with strong expertise in JavaScript as my core programming language. 
                I have real-time experience in React.js and Node.js, with proficiency in front-end technologies like HTML, CSS, JavaScript, and frameworks such as Bootstrap, Tailwind CSS, Material UI, and Redux. On the back-end, I am skilled in Node.js, Express.js, and MongoDB, with hands-on experience in API development and integration. I have completed major projects in full-stack development and enjoy working on UI design and user-centric interfaces. 
                I am eager to apply my skills in real-world projects, continuously learn, and upgrade my technical expertise.
              </p>
            </motion.div>
          </Card>
